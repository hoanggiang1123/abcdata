...
use App\Models\TeleSaleCategory;

class TeleSaleCategoryController extends Controller
{
    protected $model;

    public function __construct(TeleSaleCategory $teleSaleCategory) {
        $this->model = $teleSaleCategory;
    }
