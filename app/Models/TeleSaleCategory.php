...
class TeleSaleCategory extends Model
{
    use HasFactory;
    ...
    public function telesales () {
        return $this->hasMany(TeleSale::class, 'category_id');
    }
    ...
    public function listItems ($params) {
        ...
        $resp = self::withCount('telesales')->when(isset($params['name']) && $params['name'] !== '', function ($query) use ($params) {
